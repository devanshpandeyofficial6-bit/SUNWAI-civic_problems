...
/**
 * SUNWAI Supabase Integration Module
 * -------------------------------------------------------------
 * Native Node.js HTTPS client for Supabase REST API.
 * Zero external npm packages required.
 * Supports dual-mode: Live Supabase database OR graceful local fallback.
 */
...
// Standard SQL schema for Supabase
...
class SupabaseService {
  ...
  async testConnection() {
    ...
    try {
      // Test querying sunwai_employees
      ...
      // If table does not exist, connection is still valid
